...
import (
	...
	"gateway/internal/client/db/pg"
	"gateway/internal/client/db/transaction"
	"gateway/internal/closer"
	"gateway/internal/config"
	"gateway/internal/service"
	noteService "gateway/internal/service/note"

	"gateway/internal/repository"
	noteRepository "gateway/internal/repository/note"
)
...
func (s *serviceProvider) NoteService(ctx context.Context) service.NoteService {
	if s.noteService == nil {
		s.noteService = noteService.NewService(
			s.NoteRepository(ctx), s.TxManager(ctx),
		)
	}
